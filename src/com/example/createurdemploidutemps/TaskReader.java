...
public class TaskReader {
	...
	public static ArrayList<EmploiDuTemps> read(File file, Context context) {
		...
		try {
			...
			while (notEmpty(ligne = br.readLine())) { // tant qu'il y a des
														// enfants
				myTasks = new ArrayList<Task>(); // creation d'une nouvelle
													// liste
				...
				while (notEmpty(ligne = br.readLine())) { // tant qu'il y a des
															// temps forts
					s = new Scanner(ligne);
					double marque = Double.valueOf(s.next()); // duree de
																// l'activite
				...
				while (notEmpty(ligne = br.readLine())) { // tant qu'il y a des
					...
					ligne = br.readLine();
					s = new Scanner(ligne);
					double duree = Double.valueOf(s.next()); // duree de
																// l'activite
					s.close();

					ligne = br.readLine();
					s = new Scanner(ligne);
					double heureDebut = Double.valueOf(s.next()); // heure de
																	// debut de
																	// l'activite
					s.close();
					...
					Task myTask = new Task(nom, description, duree, heureDebut,
							nomImage, couleur);
					myTasks.add(myTask);

					ligne = br.readLine(); // passe le saut de ligne entre les
											// requetes
